    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fade-in">
      <div className="glass-panel w-full max-w-xl p-6 sm:p-8 space-y-6 relative border-sky-500/40 shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center gap-3.5 border-b border-slate-800/80 pb-4">
          ...
          <div>
            <h3 className="text-xl font-extrabold text-white flex items-center gap-2">
              <span>Arrow English AI 이용 가이드</span>
        ...
        <div className="space-y-4 text-xs sm:text-sm">
          {/* Card 1: Default Mode */}
          <div className="p-4 sm:p-5 rounded-2xl bg-slate-900/90 border border-emerald-500/30 space-y-2">
            <div className="flex items-center gap-2">
              <Sparkles className="w-4 h-4 text-emerald-400" />
              <h4 className="font-extrabold text-emerald-300 text-sm sm:text-base">
                1. 기본 무료 모드 (API 키 미입력 상태)
              </h4>
            </div>
            <p className="text-slate-300 leading-relaxed font-normal">
              API 키를 넣지 않아도 <strong className="text-white">내장 스마트 애로우 엔진</strong>이 기본 작동합니다. 대표 예문 9가지와 주요 어순 변환, 1:1 이미지 연동, 6단계 어순 시각화, TTS 원어민 발음 듣기 등이 <strong className="text-emerald-400">100% 무료로 즉시 동작</strong>합니다.
            </p>
          </div>

          {/* Card 2: AI Key Mode & Security */}
          <div className="p-4 sm:p-5 rounded-2xl bg-slate-900/90 border border-amber-500/30 space-y-2">
            <div className="flex items-center justify-between flex-wrap gap-2">
              ...
              <button
                ...
                className="text-xs font-bold px-2.5 py-1 rounded-lg bg-amber-500/20 text-amber-300 border border-amber-500/40 hover:bg-amber-500/30 transition-colors flex items-center gap-1"
              >
                <span>🔑 API 키 설정하기</span>
              </button>
            </div>
            <p className="text-slate-300 leading-relaxed font-normal">
              임의의 복잡한 문장을 AI로 자유롭게 분석하고 싶다면 상단 메뉴의 <strong className="text-amber-300">[🔑 AI 키 설정]</strong> 버튼을 누르세요. 본인의 Google Gemini API Key를 입력하시면 정밀 어순 분석 모드로 전환됩니다.
            </p>
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-slate-900/90 border border-sky-500/30 space-y-2">
            <div className="flex items-center gap-2">
              <HardDrive className="w-4 h-4 text-sky-400" />
              <h4 className="font-extrabold text-sky-300 text-sm sm:text-base">
                3. 학습자료실 저장 & 안전 백업 안내
              </h4>
            </div>
            <p className="text-slate-300 leading-relaxed font-normal">
              <strong className="text-amber-300">💾 학습자료실</strong>에 저장된 문장은 이 브라우저의 전용 공간(localStorage)에만 안전하게 보관됩니다.
            </p>
            <div className="p-3 rounded-xl bg-slate-950 border border-slate-800 space-y-1.5 text-xs text-slate-300">
              ...
              <p className="leading-relaxed">
                다른 기기(스마트폰↔PC)에서 접속하거나 브라우저 쿠키/방문 기록을 지우면 보관함이 초기화될 수 있습니다. 중요한 학습 결과는 상단의 <strong className="text-emerald-300">[MD 저장]</strong> 또는 <strong className="text-indigo-300">[PDF 저장]</strong> 버튼으로 내 컴퓨터나 폰에 파일로 다운로드해 두세요!
              </p>
            </div>
          </div>
        </div>
